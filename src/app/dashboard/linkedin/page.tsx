...
export default function Linkedin() {
    ...
    const {
        ...
        queryKey: ['dataLinkedIn'],
        queryFn: () => getAllTableCounts('plugins-linkedin'),
    ...
    const title = "List of all tables of Linkedin Scripts along with their row count and column details";
