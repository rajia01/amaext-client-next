...
import { ThirdPartyDetails } from 'types/playwright';
import { getAllThirdPartyCounts } from "utils/api/thirdparty";
...
export default function ThirdParty() {
    ...
    const {
        ...
        queryKey: ['dataThirdParty'],
        queryFn: () => getAllThirdPartyCounts(),
        refetchOnWindowFocus: false,
        

    });

    const data = thirdpartyData?.data;

    console.log(data);

    const title = "List of all tables of Third Party Scripts along with their row count and column details";
